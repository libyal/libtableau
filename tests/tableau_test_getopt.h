...
#if !defined( _TABLEAU_TEST_GETOPT_H )
#define _TABLEAU_TEST_GETOPT_H
...
#define tableau_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t tableau_test_getopt(
                  int argument_count,
...
#endif /* !defined( _TABLEAU_TEST_GETOPT_H ) */
