...
{
	static char *function = "libtableau_notify_set_stream";
...
int libtableau_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libtableau_notify_stream_open";
...
int libtableau_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libtableau_notify_stream_close";
