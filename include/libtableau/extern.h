...
#if !defined( _LIBTABLEAU_EXTERN_H )
#define _LIBTABLEAU_EXTERN_H

/* To export functions from the libtableau DLL define LIBTABLEAU_DLL_EXPORT
 * To import functions from the libtableau DLL define LIBTABLEAU_DLL_IMPORT
